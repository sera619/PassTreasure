...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.updateFrame = QFrame(self.scrollAreaWidgetContents_2)
        ...
        self.verticalLayout_24 = QVBoxLayout(self.updateFrame)
        self.verticalLayout_24.setObjectName(u"verticalLayout_24")
        self.innerUpdateFrame = QFrame(self.updateFrame)
        self.innerUpdateFrame.setObjectName(u"innerUpdateFrame")
        self.innerUpdateFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.innerUpdateFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_22 = QVBoxLayout(self.innerUpdateFrame)
        self.verticalLayout_22.setSpacing(4)
        self.verticalLayout_22.setObjectName(u"verticalLayout_22")
        self.verticalLayout_22.setContentsMargins(0, 0, 0, 0)
        self.label_19 = QLabel(self.innerUpdateFrame)
        ...
        self.label_19.setStyleSheet(u"font: bold 10pt \"Segoe UI\";")

        self.verticalLayout_22.addWidget(self.label_19)

        self.frame_17 = QFrame(self.innerUpdateFrame)
        ...
        self.line_9 = QFrame(self.frame_17)
        self.line_9.setObjectName(u"line_9")
        self.line_9.setStyleSheet(u"background:rgb(170, 0, 0)")
        ...
        self.frame_18 = QFrame(self.innerUpdateFrame)
        ...
        self.label_20.setMinimumSize(QSize(130, 0))
        font2 = QFont()
        font2.setBold(True)
        ...
        self.autoUpdatesSelect = QCheckBox(self.frame_18)
        self.autoUpdatesSelect.setObjectName(u"autoUpdatesSelect")

        self.horizontalLayout_17.addWidget(self.autoUpdatesSelect)


        self.verticalLayout_22.addWidget(self.frame_18)

        self.checkUpdateFrame = QFrame(self.innerUpdateFrame)
        self.checkUpdateFrame.setObjectName(u"checkUpdateFrame")
        self.checkUpdateFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.checkUpdateFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_18 = QHBoxLayout(self.checkUpdateFrame)
        self.horizontalLayout_18.setObjectName(u"horizontalLayout_18")
        self.horizontalLayout_18.setContentsMargins(-1, 4, -1, 4)
        self.updateStatusLabel = QLabel(self.checkUpdateFrame)
        self.updateStatusLabel.setObjectName(u"updateStatusLabel")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.updateStatusLabel.sizePolicy().hasHeightForWidth())
        self.updateStatusLabel.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_18.addWidget(self.updateStatusLabel)

        self.btnStartUpdate = QPushButton(self.checkUpdateFrame)
        self.btnStartUpdate.setObjectName(u"btnStartUpdate")

        self.horizontalLayout_18.addWidget(self.btnStartUpdate)

        self.btnCheckUpdate = QPushButton(self.checkUpdateFrame)
        self.btnCheckUpdate.setObjectName(u"btnCheckUpdate")

        self.horizontalLayout_18.addWidget(self.btnCheckUpdate)


        self.verticalLayout_22.addWidget(self.checkUpdateFrame)


        self.verticalLayout_24.addWidget(self.innerUpdateFrame)
        ...
        sizePolicy1.setHeightForWidth(self.backupFrame.sizePolicy().hasHeightForWidth())
        self.backupFrame.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.backupDeleteBox.sizePolicy().hasHeightForWidth())
        self.backupDeleteBox.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.btnClearBackup.sizePolicy().hasHeightForWidth())
        self.btnClearBackup.setSizePolicy(sizePolicy3)
...
"padding:  5px 0px 5px 0px;")
        ...
        self.editCategoryBox.setStyleSheet(u"font:  9pt \"Segoe UI\";")
        ...
        sizePolicy4.setHeightForWidth(self.exportFilenameLineEdit.sizePolicy().hasHeightForWidth())
        self.exportFilenameLineEdit.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.aboutLabel.sizePolicy().hasHeightForWidth())
        self.aboutLabel.setSizePolicy(sizePolicy5)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.label_19.setText(QCoreApplication.translate("SettingsWindow", u"Updates", None))
        self.label_20.setText(QCoreApplication.translate("SettingsWindow", u"Auto. check updates:", None))
        self.autoUpdatesSelect.setText(QCoreApplication.translate("SettingsWindow", u"Active", None))
        self.updateStatusLabel.setText(QCoreApplication.translate("SettingsWindow", u"Check  not started.", None))
        self.btnStartUpdate.setText(QCoreApplication.translate("SettingsWindow", u"Start Update", None))
        self.btnCheckUpdate.setText(QCoreApplication.translate("SettingsWindow", u"Check Updates", None))
