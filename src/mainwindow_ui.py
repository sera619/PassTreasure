...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_10.addWidget(self.mainTitleIcon, 0, Qt.AlignmentFlag.AlignRight)

        self.mainTitleLabel = QLabel(self.titleFrame)
        self.mainTitleLabel.setObjectName(u"mainTitleLabel")
        font = QFont()
        font.setFamilies([u"Digital-7"])
        ...
        self.leftLayout.setContentsMargins(4, -1, 4, -1)
        ...
        self.rightLayout.setContentsMargins(4, -1, 4, -1)
        ...
        font1.setBold(True)
        self.detailTitle.setFont(font1)
...
"}")
        ...
        self.serviceHBox.addWidget(self.btnEditService, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        self.usernameEditLayout.addWidget(self.btnEditUsername, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        self.passEditLayout.addWidget(self.btnEditPass, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        self.footerLabel.setFont(font3)
